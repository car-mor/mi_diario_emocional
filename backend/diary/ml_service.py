...
try:
    ...
    print(f"   • BETO fine-tuneado: {MODEL_ID} (desde Hugging Face Hub)")  # Mensaje actualizado
    print(f"   • Dispositivo: {DEVICE}")

except Exception as e:
    # Este error ahora ocurrirá si no hay internet o el ID del modelo es incorrecto
    print(f"❌ Error crítico cargando modelos: {e}")
    print("\n📋 SOLUCIÓN:")
    print("   1. Asegúrate de que el servidor tenga conexión a internet.")
    print(f"   2. Verifica que el ID del modelo '{MODEL_ID}' sea correcto en Hugging Face Hub.")
