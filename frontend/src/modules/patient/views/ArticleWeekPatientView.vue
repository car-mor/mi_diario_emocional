        ...
        <main class="flex-1 flex flex-col overflow-y-auto p-8 lg:p-1">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 md:p-10 lg:p-16 max-w-4xl mx-auto my-6">
                <div class="text-center mb-8">
                    ...
                    <p class="text-lg text-gray-600 font-semibold">Silvia Congost</p>
                ...
                <div class="text-gray-700 leading-relaxed text-base md:text-lg">
                    ...
                    <p class="mb-6 text-justify">
                        Decía Epicteto que deberíamos mirar la vida como si de un banquete se tratara. Cuando te pasen las bandejas, extiende la mano y sírvete una porción moderada. Si una fuente pasa de largo, disfruta de lo que tienes en el plato. Y si un manjar aún no te ha sido ofrecido, espera pacientemente tu turno.
                    </p>
                    ...
                    <div class="mt-8 pt-4 border-t border-gray-200 text-gray-600 text-sm">
                        ...
                        <p class="mb-2">
                            **Silvia Congost** es una psicóloga, conferenciante y escritora especializada en dependencia emocional, autoestima y rupturas nacida en España. Autora de varios libros, su trabajo se centra en ayudar a las personas a sanar sus relaciones y fortalecer su bienestar emocional.
                        </p>
                        <p class="text-xs text-gray-500">
                            **Fuente:** Adaptado de una publicación original de El País. <br></br>
                            **Imagen por: Marta Sevilla / El País**<br></br>
                            Ver más en: <a href="https://elpais.com/eps/psicologia-y-bienestar/2025-03-27/como-superar-el-trauma-de-una-ruptura-una-guia-practica.html" class="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">https://elpais.com/eps/psicologia-y-bienestar/2025-03-27/como-superar-el-trauma-de-una-ruptura-una-guia-practica.html</a>
                        </p>
                    </div>
                </div>
            </div>
